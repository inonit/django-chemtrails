# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-06-07 12:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_types', django.contrib.postgres.fields.jsonb.JSONField(default=dict, help_text='Mapping of relation types optionally with a map of properties for matching the relation type node. Example: {"USER": {"is_superuser": true}}', verbose_name='relation types')),
